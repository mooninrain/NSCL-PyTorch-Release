...
```
jac-crun 5 scripts/visualize-execution.py --data-dir data_dir/clevr_mini --batch-size 8 --curriculum all --supervision derender --load dumps/clevr_mini/desc_nscl_derender/variant_expr_1/checkpoints/epoch_15.pth --desc experiments/clevr/desc_nscl_derender.py --dataset_name clevr --loss_type joint --expr <expr_name>
```
