...
__all__ = ['make_im2concept_v2_configs', 'Im2Conceptv2Model']


def make_im2concept_v2_configs():
...
class Im2Conceptv2Model(nn.Module):
    def __init__(self, args, vocab, configs):
        ...
        self.scene_graph = sng.scene_graph_with_monet_v2(256, configs.model.sg_dims, args.loss_type, args.pretrained_monet, args.freeze_monet)
